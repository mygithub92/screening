    ...
    <ng-container>
      ...
      <ul
        *ngIf="item.items && active"
        [@children]="
          (app.isHorizontal() || app.isSlim()) && root ? (active ? 'visible' : 'hidden') : active ? 'visibleAnimated' : 'hiddenAnimated'
        "
      >
        <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
          <li tt-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>
        </ng-template>
      </ul>
    </ng-container>
  `,
